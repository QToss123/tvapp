...
```
cd existing_repo
git remote add origin https://git.wsldevops.com/liqvid/liqvid-frontend-app.git
git branch -M master
...
* [Set up project integrations](https://git.wsldevops.com/liqvid/liqvid-frontend-app/-/settings/integrations)
